    ...
    <form className="" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex">
        <div className="mt-8 mb-8 place-content-center">
          <div className="m-8">
            <div
              className={"col-span-1 font-manrope font-bold text-xl my-3 h-96"}
            >
              ...
              <div className="mb-3 xl:w-96 h-full">
                <div className="grid space-y-5">
                  <textarea
                    className="form-control w-full border-2 resize-none outline-none rounded-md border-wine border-solid p-3 "
                    ...
                    onInput={(e) => {
                      ...
                      comment.current.style.height =
                        Math.min(comment.current.scrollHeight, minHeight) +
                        "px";
                    }}
                    ref={comment}
                    value={commentary}
