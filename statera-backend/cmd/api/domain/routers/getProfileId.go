...
/*GetProfileID allows to extract values of a user profile*/
func GetProfileID(writer http.ResponseWriter, request *http.Request) {
	...
	json.NewEncoder(writer).Encode(model.IdProfileResponse{
		ID: profile.ID.Hex(),
	})
}
